...
Plugins created by the Ava community. These extend Ava with additional functionality. You can use these by dropping them into your `app/plugins/` folder and enabling them in your config.
